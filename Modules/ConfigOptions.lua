...
return {
	...
	{ var = "conditionLowMana", type = "check", label = "Are you always on Low Mana?", ifCond = "LowMana", tooltip = "You will automatically be considered to be on Low Mana if you have at least 65% Mana reserved,\nbut you can use this option to force it if necessary.", apply = function(val, modList, enemyModList)
	...
	{ var = "multiplierShockedEnemyRecently", type = "count", label = "# of Shocked an Enemies Recently:", ifMult = "ShockedEnemyRecently", apply = function(val, modList, enemyModList)
		modList:NewMod("Multiplier:ShockedEnemyRecently", "BASE", val, "Config", { type = "Condition", var = "Combat" })
		modList:NewMod("Condition:ShockedEnemyRecently", "FLAG", 1 <= val, "Config", { type = "Condition", var = "Combat" })
	end },
	...
	{ var = "conditionBeenSpellDamageRecently", type = "check", label = "Have you been Spell Damage Recently?", ifCond = "BeenSpellDamageRecently", apply = function(val, modList, enemyModList)
		modList:NewMod("Condition:BeenSpellDamageRecently", "FLAG", true, "Config", { type = "Condition", var = "Combat" })
	end },

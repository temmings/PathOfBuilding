...
local preFlagList = {
	...
	["^arrows deal "] = { tagList = { { type = "SkillType", skillType = SkillType.Attack }, { type = "SkillType", skillType = SkillType.Projectile } } },
...
local modTagList = {
	...
	["if you[' ]h?a?ve taken spell damage recently"] = { tag = { type = "Condition", var = "BeenSpellDamageRecently" } }, -- Boots enchantment
	...
	["for each enemy you have shocked recently"] = { tag = { type = "Multiplier", var = "ShockedEnemyRecently" } },
}
